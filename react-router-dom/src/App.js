...
// import Child1 from './stateuplifiting/counter/Child1/Child1'
// import Child22 from './stateuplifiting/counter/Child2/Child2'
...
import React, { useState } from 'react'
import Products from "./stateuplifiting/Addtocart/Products"
import Cart from "./stateuplifiting/Addtocart/Cart"
...
const App = () => {
  ...
  return (
    <div>
      <Products data={Product} addtocart={addtocart}/>
      <Cart cart={cart}/>
    </div>
  )
}
