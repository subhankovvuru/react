...
// import Cart from "./classcomponents/cart/cart";
// import Count from "./classcomponents/count/count";
...
//     return(
//       <div style={{display:"flex", flexWrap:"wrap", alignItems:"center", border:'2px solid black'}}>
    
//        {data.map(x=>{
//          return(
          
//           <div>
//              <Cart n={x.id} img={x.image}/>
//           </div>
